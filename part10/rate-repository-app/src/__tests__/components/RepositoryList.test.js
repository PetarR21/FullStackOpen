...
// Create a test-friendly version without SafeAreaProvider
const TestRepositoryListContainer = ({ repositories }) => {
...
describe('RepositoryList', () => {
  describe('RepositoryListContainer', () => {
    it('renders repository information correctly', () => {
      ...
      render(<TestRepositoryListContainer repositories={repositories} />)

      const repositoryItems = screen.getAllByTestId('repositoryItem')

      expect(repositoryItems).toHaveLength(2)

      // Test that all expected text content is present
      ...
      // Test that there are 2 elements with text "3" (reviews count for both repos)
